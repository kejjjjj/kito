...
void Recorder::Playback(usercmd_s* cmd)
{
	...
	vec3_t angles = { SHORT2ANGLE(it->angles[0]), SHORT2ANGLE(it->angles[1]), SHORT2ANGLE(it->angles[2])};
	


	//cg::CG_SetPlayerAngles(cg::vAngle->angles, angles);

	//cg::CG_SetServerAngles(angles);
